...
class ImageService
{
    ...
    public function store(UploadedFile $file, string $folder): string
    {
        ...
        if ($path === false) {
            throw new \RuntimeException('No se pudo almacenar la imagen en el disco público.');
        }
     ...
     *
     * @param  list<UploadedFile>  $files  Archivos subidos
     * @param  string  $folder  Subcarpeta dentro de images/
     * @return list<string>
     */
