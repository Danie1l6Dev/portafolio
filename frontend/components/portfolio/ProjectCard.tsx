  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_1px_3px_0_rgb(0_0_0_/_0.07)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_8px_20px_-4px_rgb(0_0_0_/_0.12)]">
      ...
      <div className="flex flex-1 flex-col gap-3 px-5 py-4">
        ...
        {/* Título */}
        <h3 className="font-semibold leading-snug text-slate-900 transition-colors group-hover:text-sky-600">
          {project.title}
        </h3>
        ...
        <div className="pt-1">
          <Link
            ...
            className="inline-flex items-center gap-1 text-sm font-medium text-sky-600 transition-colors hover:text-sky-800"
          >
            Ver proyecto
